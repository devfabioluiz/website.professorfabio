var CARGOS = {
  docente1_18h: {
    ...
    referencias: [
      ...
      { nivel: "D", ref: 6, vb: 2231.06, complemento: 0.00  },
      { nivel: "D", ref: 7, vb: 2499.36, complemento: 0.00  },
      { nivel: "D", ref: 8, vb: 2799.27, complemento: 0.00  },
      { nivel: "D", ref: 9, vb: 3135.19, complemento: 0.00  }
    ]
  },
  docente1_30h: {
    ...
    extincao: false,
    referencias: [
      { nivel: "C", ref: 3, vb: 2647.30, complemento: 1003.53 },
      { nivel: "D", ref: 4, vb: 2964.98, complemento: 685.85  },
      { nivel: "D", ref: 5, vb: 3320.78, complemento: 330.05  },
      { nivel: "D", ref: 6, vb: 3718.43, complemento: 0.00    },
      { nivel: "D", ref: 7, vb: 4165.59, complemento: 0.00    },
      { nivel: "D", ref: 8, vb: 4665.47, complemento: 0.00    },
      { nivel: "D", ref: 9, vb: 5225.31, complemento: 0.00    }
    ]
  },
  docente2_22h: {
    ...
    referencias: [
      ...
      { nivel: "D", ref: 9, vb: 2786.83, complemento: 0.00    }
    ]
  },
  exfaep1_40h: {
    nome: "Professor Ex-Faep Docente I - 40h",
    carga: 40,
    extincao: true,
    referencias: [
      ...
      { nivel: "D", ref: 6, vb: 4959.06, complemento: 0.00    },
      { nivel: "D", ref: 7, vb: 5554.11, complemento: 0.00    },
      { nivel: "D", ref: 8, vb: 6220.64, complemento: 0.00    },
      { nivel: "D", ref: 9, vb: 6967.11, complemento: 0.00    }
    ]
  }
};
